...
class Article(models.Model):
    ...
    sub_heading_two = models.CharField(max_length=200, blank=True)
    ...
    sub_heading_three = models.CharField(max_length=200, blank=True)
    ...
    sub_heading_four = models.CharField(max_length=200, blank=True)
    ...
    sub_heading_five = models.CharField(max_length=200, blank=True)
    ...
    sub_heading_six = models.CharField(max_length=200, blank=True)
